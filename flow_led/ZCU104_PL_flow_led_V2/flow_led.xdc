# clock signal
set_property -dict {PACKAGE_PIN E23 IOSTANDARD LVDS} [get_ports clk_in1_n]
set_property -dict {PACKAGE_PIN F23 IOSTANDARD LVDS} [get_ports clk_in1_p]

# connect to "GPIO_PB_SW3", Pushbuttons SW18 to control: active-High (when push)
