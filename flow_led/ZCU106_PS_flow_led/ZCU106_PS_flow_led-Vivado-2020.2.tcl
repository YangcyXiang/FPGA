...
#
# ZCU106_PS_flow_led.tcl: Tcl script for re-creating project 'ZCU106_PS_flow_led'
#
# Generated by Vivado on Mon Jul 29 12:16:29 +0800 2024
...
#
# 1. This project restoration tcl script (ZCU106_PS_flow_led.tcl) that was generated.
#
...
set _xil_proj_name_ "ZCU106_PS_flow_led"
...
set script_file "ZCU106_PS_flow_led.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../../FPGA_backup/flow_led/ZCU106_PS_flow_led"]"
...
proc cr_bd_system { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU_MIO_TREE_PERIPHERALS { \
     ...
     0#USB 0#Gem \
     0#USB 0#Gem \
     1##DPAUX#DPAUX#DPAUX#DPAUX##PMU GPO \
     1#GPIO0 MIO#GPIO0 \
     1#PMU GPO \
     1#SD 1#USB \
     1#SD 1#USB \
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_TopLeft":"-114,-234",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r6  2020-01-29 bk=1.5227 VDI=41 GEI=36 GUI=JA:10.0 non-TLS
#  -string -flagsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 1 -x 310 -y -50 -defaultsOSRD
levelinfo -pg 1 0 310 620
pagesize -pg 1 -db -bbox -sgen 0 -140 620 180
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse system.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../../FPGA_backup/flow_led/ZCU106_PS_flow_led/ZCU106_PS_flow_led.gen/sources_1/bd/system/hdl/system_wrapper.v" ]
} else {
...
set obj [get_runs synth_1]
set_property -name "auto_incremental_checkpoint.directory" -value "D:/Workspace/github/FPGA/flow_led/ZCU106_PS_flow_led/ZCU106_PS_flow_led.srcs/utils_1/imports/synth_1" -objects $obj
...
set obj [get_runs impl_1]
set_property -name "auto_incremental_checkpoint.directory" -value "D:/Workspace/github/FPGA/flow_led/ZCU106_PS_flow_led/ZCU106_PS_flow_led.srcs/utils_1/imports/impl_1" -objects $obj
