# clock signal
set_property -dict {PACKAGE_PIN G9 IOSTANDARD LVDS} [get_ports clk_in1_n]
set_property -dict {PACKAGE_PIN H9 IOSTANDARD LVDS} [get_ports clk_in1_p]

# connect to "GPIO_SW_E", Pushbuttons SW17 to control: active-High (when push)
set_property -dict {PACKAGE_PIN AC14 IOSTANDARD LVCMOS12} [get_ports reset]
