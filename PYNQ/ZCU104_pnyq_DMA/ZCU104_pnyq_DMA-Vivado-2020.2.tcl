...
#
# ZCU104_pnyq_DMA.tcl: Tcl script for re-creating project 'ZCU104_pnyq_DMA'
#
# Generated by Vivado on Mon Jul 29 14:49:32 +0800 2024
...
#
# 1. This project restoration tcl script (ZCU104_pnyq_DMA.tcl) that was generated.
#
...
set _xil_proj_name_ "ZCU104_pnyq_DMA"
...
set script_file "ZCU104_pnyq_DMA.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../../FPGA_backup/PYNQ/ZCU104_pnyq_DMA"]"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "pynq_DMA_wrapper" -objects $obj
...
# Proc to create BD pynq_DMA
proc cr_bd_pynq_DMA { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name pynq_DMA
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.544712",
   "Default View_TopLeft":"0,-97",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r6  2020-01-29 bk=1.5227 VDI=41 GEI=36 GUI=JA:10.0 non-TLS
#  -string -flagsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 3 -x 1030 -y 90 -defaultsOSRD
preplace inst axi_dma_0 -pg 1 -lvl 5 -x 1870 -y 300 -defaultsOSRD
preplace inst axis_data_fifo_0 -pg 1 -lvl 4 -x 1530 -y 100 -defaultsOSRD
preplace inst ps8_0_axi_periph -pg 1 -lvl 4 -x 1530 -y 300 -defaultsOSRD
preplace inst rst_ps8_0_100M -pg 1 -lvl 1 -x 200 -y 550 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 2 -x 540 -y 270 -defaultsOSRD
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 5 30 280 370 140 720 220 1330 430 1680
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 0 4 20 150 NJ 150 710J 200 1320
preplace netloc rst_ps8_0_100M_peripheral_aresetn 1 1 4 380 160 680J 210 1370 420 1690J
preplace netloc ps8_0_axi_periph_M00_AXI 1 4 1 1670 250n
preplace netloc axi_smc_M00_AXI 1 2 1 690 60n
preplace netloc axi_dma_0_M_AXI_MM2S 1 1 5 390 170 700J 180 1340J 20 NJ 20 2040
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 3 1 1350 70n
preplace netloc axis_data_fifo_0_M_AXIS 1 4 1 1680 100n
preplace netloc axi_dma_0_M_AXI_S2MM 1 1 5 400 180 670J 190 1360J 180 NJ 180 2030
preplace netloc axi_dma_0_M_AXIS_MM2S 1 3 3 1370 10 NJ 10 2050
levelinfo -pg 1 0 200 540 1030 1530 1870 2080
pagesize -pg 1 -db -bbox -sgen 0 0 2080 650
"
}
...
# End of cr_bd_pynq_DMA()
cr_bd_pynq_DMA ""
set_property REGISTERED_WITH_MANAGER "1" [get_files pynq_DMA.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files pynq_DMA.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse pynq_DMA.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../PYNQ/ZCU104_pnyq_DMA/ZCU104_pnyq_DMA.gen/sources_1/bd/pynq_DMA/hdl/pynq_DMA_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse pynq_DMA.bd] -top]
  add_files -norecurse -fileset sources_1 $wrapper_path
}

if { [get_property IS_LOCKED [ get_files -norecurse pynq_DMA.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../../FPGA_backup/PYNQ/ZCU104_pnyq_DMA/ZCU104_pnyq_DMA.gen/sources_1/bd/pynq_DMA/hdl/pynq_DMA_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse pynq_DMA.bd] -top]
  add_files -norecurse -fileset sources_1 $wrapper_path
}
...
set obj [get_runs synth_1]
set_property -name "auto_incremental_checkpoint.directory" -value "D:/Workspace/github/FPGA/PYNQ/ZCU104_pnyq_DMA/ZCU104_pnyq_DMA.srcs/utils_1/imports/synth_1" -objects $obj
...
set obj [get_runs impl_1]
set_property -name "auto_incremental_checkpoint.directory" -value "D:/Workspace/github/FPGA/PYNQ/ZCU104_pnyq_DMA/ZCU104_pnyq_DMA.srcs/utils_1/imports/impl_1" -objects $obj
